...
4) XFCE
				''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install mate-core mate-desktop-environment-extra mate-desktop-environment-extras")
								print (" ")
							elif opcion2 == "3":
								cmd = os.system("apt-get install gnome-core kali-defaults kali-root-login desktop-base")
								print (" ")
							elif opcion2 == "4":
								cmd = os.system("apt-get install kali-defaults kali-root-login desktop-base xfce4 xfce4-places-plugin xfce4-goodies")
								print (" ")
							elif opcion2 == "back":
								inicio()
							elif opcion2 == "gohome":
